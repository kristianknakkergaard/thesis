...
\begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%
      \put(4169,4748){\makebox(0,0)[l]{\strut{}Free gas}}%
      \csname LTb\endcsname%
      \put(4169,4418){\makebox(0,0)[l]{\strut{}$n_F / n_B^{1/3} = 0.2$}}%
      \csname LTb\endcsname%
      \put(4169,4088){\makebox(0,0)[l]{\strut{}$n_F / n_B^{1/3} = 0.4$}}%
      \csname LTb\endcsname%
      \put(4169,3758){\makebox(0,0)[l]{\strut{}$n_F / n_B^{1/3} = 0.6$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{Figures/OccupancyT0/Occupancyplot}}%
    \gplfronttext
  \end{picture}%
\endgroup
