...
\label{Appendix.longrangeorder.pairingphase} % For referencing this appendix elsewhere, use \ref{AppendixC}
\chead{}
\lhead{Appendix B. \emph{Long range order of the pairing phase}} % This is for the header on each page - perhaps a shortened title
