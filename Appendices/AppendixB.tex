...
\chapter{No inversion symmetry of the single wire} % Main appendix title

\label{AppendixB} % For referencing this appendix elsewhere, use \ref{AppendixA}
\chead{}
\lhead{Appendix B. \emph{No inversion symmetry, 1 wire}} % This is for the header on each page - perhaps a shortened title
