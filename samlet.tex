...
In this final part we first discuss the results and methods used in the present thesis. We further comment on how we can expand on the analysis in future work. We then move on to the conclusion. There we summarize the main results of the thesis. 
\newpage 
