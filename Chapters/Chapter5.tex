...
%correlation:
\draw[-, thick, red]  (1.0271, 0.08) to[out=90, in=90] (1.6615, 0.08);
\draw (1.0271 + 0.3172, 0.26) node[cross, thick, black]{};
...
%correlation:
\draw[-, thick, red]  (8.35, 0.08) to[out=90, in=90, distance = 0.25cm] (8.65, 0.08);
...
\draw[*-] (12.85, 0.08); 
\end{tikzpicture}
\caption{An intuitive picture of how the correlations tend to order the system. The fermions are depicted by black dots. Left: no pairing; the fermions are uncorrelated and are placed randomnly. The correlation marked with a red curve is therefore crossed over. Right: nonzero pairing; the positions of the fermions are correlated. They tend to form a pattern with an interparticle distance of $1 / k_F$. The correlation is depicted as the red curve.}
\label{fig.positioncorrelations}
\end{figure}
We can come with an intuitive picture of the effect of the nonzero pairing. When there is no pairing, $\Delta_k = 0$, the positions of the fermions are \textit{not} correlated and they are randomnly distributed along the wire. This is shown to the left in figure \ref{fig.positioncorrelations}. When there is a pairing present, $\Delta_k \neq 0$, the pair wave function is nonzero, which describes that the position of one fermion is correlated to another. The fermions tend to have an interparticle distance of $1 / k_F$ and hereby form the pattern to the right in figure \ref{fig.positioncorrelations}.
