...
\draw[-, thick, red]  (cor31) to[out=-90, in=-90, distance=0.8cm] (cor32);
\end{tikzpicture}
\caption{Spatial destribution of the fermions along the wire. The mean interparticle distance $1 / n_F$ is marked by the ticks along in the lines. Left: uncorrelated fermions. The interparticle distance varies little around the mean. Right: The fermions pair up with correlations that are significant over several interparticle distances $1/n_F$. Correlated fermions are incircled in red.}
