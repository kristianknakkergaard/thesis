...
\begin{equation}
\frac{\tilde{V}_{FF}^\text{ind}(x,0)}{\epsilon_{F,0}} = - 8\left( \frac{m_F}{m_B} + \frac{m_B}{m_F} + 2 \right) \frac{n_B^{1/3}}{n_F}(n_Ba_{BF}^3)^{2/3} \cdot \frac{\text{e}^{ -\frac{ \sqrt{2}|x|}{\xi} } }{k_F|x|}.
