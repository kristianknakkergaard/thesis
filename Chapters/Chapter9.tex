...
\end{equation} 
both for $j=1$ and $j=2$. It is then clear, that the total spinor $C_k$ is also unaffected by the transformation. As a result the Hamiltonian is invariant under $C$, and $\sigma_1^2 = \mathbb{I}$ so the transformation squares to unity. 
