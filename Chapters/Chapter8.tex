...
%----------------------------------------------------------------------------------------
In the chapter we will introduce a second wire parallel to the first one already studied. The aim of this chapter is to calculate the additional (interwire) induced interaction between the wires. The approach mirrors chapter \ref{Chapter3}. For this reason we will not go in as much detail in the present chapter.
...
\begin{figure} 
\begin{center}  
\input{Figures/InducedInteractionInterwireMomentumSpace/InducedInteraction.tex}  
...
\begin{figure} 
\begin{center}  
\input{Figures/InducedInteractionInterwireRealSpace/InducedInteraction.tex}  
