...
\section{\texorpdfstring{$\mathbb{Z}_2$}{Z2} topological index and phases}
...
For $\mu < 0$, $\varepsilon_k > 0$ for all $k$ and $\theta_k(c = 0)$ is continuous. In this case the invariant simply becomes:
\begin{equation}
